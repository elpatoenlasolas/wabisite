...
//==== Privacy Policy ====//
var modalPp = document.getElementById("popUpPp");
var btnPp = document.getElementById("popBtnPp");
var spanPp = document.getElementsByClassName("closePp")[0];
...
//======= Cookies Pop Up =======//
var modalCk = document.getElementById("popUpCk");
var btnCk = document.getElementById("popBtnCk");
var spanCk = document.getElementsByClassName("closeCk")[0];

btnCk.onclick = function() {
  modalCk.style.display = "block";
}

spanCk.onclick = function() {
  modalCk.style.display = "none";
}

window.onclick = function(event) {
  if (event.target == modalCk) {
    modalCk.style.display = "none";
  }
};


// FORM MESSAGE RECEIVED//


function Submit() {

    document.getElementById('contactForm').style.display = "none";
    document.getElementById('formAlert').style.display= "inline";
